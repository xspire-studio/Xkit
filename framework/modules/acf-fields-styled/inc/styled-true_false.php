...
/*
*  ACF Styled True / False Field Class
*
...
function acf_add_field_true_false(){
		...
		class acf_field_true_false extends acf_field {
			...
			*/
			public function __construct() {
				...
				$this->label = esc_html__("True / False" , 'xkit' );
			...
			*/
			public function render_field( $field ) {
				...
				echo '<ul class="acf-checkbox-list acf-bl ' . acf_esc_attr($field['class']) . '">';
					...
					echo '<li><label><input ' . acf_esc_attr($atts) . '/><span class="toggle"></span>' . $field['message'] . '</label></li>';
				echo '</ul>';
			}
			...
			*/
			public function render_field_settings( $field ) {
				...
				acf_render_field_setting( $field, array(
					'label'			=> esc_html__('Message', 'xkit' ),
					'instructions'	=> esc_html__('eg. Show extra content', 'xkit' ),
					'type'			=> 'text',
					'name'			=> 'message',
				));
